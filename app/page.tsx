...
import { ArrowRight, Sparkles, Shield, Code, Image as ImageIcon, Globe } from "lucide-react";

export default function LandingPage() {
  return (
    <div className="min-h-screen w-full bg-[#000000] text-white selection:bg-cortex-purple selection:text-white font-sans overflow-x-hidden relative">
      
      {/* Animated Grid Background */}
      <div className="absolute inset-0 bg-grid-pattern [mask-image:linear-gradient(to_bottom,white_20%,transparent_80%)] pointer-events-none opacity-40 z-0" />

      {/* Navbar */}
      <nav className="fixed top-0 w-full z-50 bg-[#000000]/60 backdrop-blur-2xl border-b border-white/5">
      ...
      {/* Hero Section */}
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 px-6 flex flex-col items-center text-center z-10">
        ...
        <motion.div initial={{ opacity: 0, scale: 0.8, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} transition={{ duration: 1, ease: "easeOut" }} className="w-48 h-48 md:w-64 md:h-64 mb-4 mix-blend-screen relative">
      ...
      {/* Bento Grid Features with Floating Animations */}
      <section id="features" className="py-24 px-6 max-w-7xl mx-auto z-10 relative">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <motion.div whileHover={{ y: -10 }} transition={{ type: "spring", stiffness: 300 }} className="col-span-1 md:col-span-2 bg-[#0d0d0f]/80 backdrop-blur-lg border border-white/10 rounded-[2rem] p-8 md:p-12 relative overflow-hidden group hover:border-blue-500/50 hover:shadow-[0_0_40px_rgba(59,130,246,0.15)]">
            ...
            <h3 className="text-2xl md:text-3xl font-bold mb-4">Advanced IDE Preview</h3>
            <p className="text-gray-400 leading-relaxed max-w-md">Cortex writes code like a senior developer. Toggle between raw syntax-highlighted code and a live visual preview of HTML/Web apps instantly.</p>
          </motion.div>
          
          <motion.div whileHover={{ y: -10 }} transition={{ type: "spring", stiffness: 300 }} className="col-span-1 bg-[#0d0d0f]/80 backdrop-blur-lg border border-white/10 rounded-[2rem] p-8 relative overflow-hidden group hover:border-pink-500/50 hover:shadow-[0_0_40px_rgba(236,72,153,0.15)]">
            ...
            <h3 className="text-2xl font-bold mb-4">Visual Gen</h3>
            <p className="text-gray-400 leading-relaxed">Turn your imagination into reality with integrated, high-fidelity image generation with dynamic lightboxes.</p>
          </motion.div>

          <motion.div whileHover={{ y: -10 }} transition={{ type: "spring", stiffness: 300 }} className="col-span-1 bg-[#0d0d0f]/80 backdrop-blur-lg border border-white/10 rounded-[2rem] p-8 relative overflow-hidden group hover:border-green-500/50 hover:shadow-[0_0_40px_rgba(34,197,94,0.15)]">
          ...
          <motion.div whileHover={{ y: -10 }} transition={{ type: "spring", stiffness: 300 }} className="col-span-1 md:col-span-2 bg-[#0d0d0f]/80 backdrop-blur-lg border border-white/10 rounded-[2rem] p-8 md:p-12 relative overflow-hidden group hover:border-cortex-purple/50 hover:shadow-[0_0_40px_rgba(168,127,251,0.15)]">
      ...
      {/* Footer CTA */}
      <section className="py-24 px-6 text-center border-t border-white/5 relative overflow-hidden z-10">
        ...
        <Link href="/login" className="inline-flex bg-white text-black px-10 py-4 rounded-full font-bold items-center justify-center gap-2 hover:bg-gray-200 transition-all hover:scale-105 active:scale-95 shadow-[0_0_30px_rgba(255,255,255,0.2)] relative z-10">
